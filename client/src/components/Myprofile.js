...
function Myprofile() {
  ...
  function getSearchComponent(term) {
    ...
    const partialMatchKeys = Object.keys(searchMap).filter(k => !k.includes(" "));
  ...
  return (
    <div>
      <div className='pageContent'>
        ...
        {missionToggled && (
          <div style={{ marginTop: '20px' }}>
            ...
            <div className="myprofileDropdownText">
              <u style={{fontWeight: "bold", fontSize: "6vw"}}>OPERATION FILTHY LAUNDRY</u><br/><br/>
              Agent Papyrus,<br/><br/>
              We're so sorry it has come to this.<br/><br/>
              Your mission: Apprehend your former student, Agent Marble, and bring them to justice.<br/><br/>
              On that despicable day, they betrayed their country. They betrayed you. But most importantly, they betrayed our agency. And now, five years later, we're finally going to pay them back.<br/><br/>
              <u style={{fontWeight: "bold", fontSize: "6vw"}}>YOUR MISSION DETAILS<br/>(AGENT PAPYRUS)</u><br/><br/>
              You will be on a window stake out while your new student / agent Rookie works the field.<br/><br/>
              Lunch will be provided for you. Agent Rookie will not receive lunch so please don't brag about your lunch to them.<br/><br/>
              Finally, we hope it goes without saying to never share your password.<br/><br/>
              <u style={{fontWeight: "bold", fontSize: "6vw"}}>***INFORMATION TO SHARE WITH AGENT ROOKIE BELOW***</u><br/><br/>
              Our below average code-breaking team is sifting through data on Marble but currently they can only confirm they are wearing <u><strong style={{fontWeight: "normal"}}>jeans</strong></u> and an <u><strong style={{fontWeight: "normal"}}>animal necklace</strong></u>.<br/><br/>
            </div>
          </div>
        )}
        ...
        {lunchToggled && (
          <div style={{ marginTop: '20px' }}>
            <div className="myprofileDropdownText">
              ...
              Choose one: Chicken, Beef, Tofu.<br/><br/>
        ...
        <div className="thinOrangeLine" /><br/><br/><br/>

        <div className='greenBar'>MY MISSION HISTORY</div>
        <div className='missionHistoryText'>
          Agent Papyrus, click <a style={{color:'#f9df39'}} href='./myhistory' target="_blank">here</a> to review your past missions.
        </div>
        ...
        <div className='missionHistoryText'>
          For company records, enter the subject matter here and we will pull up the relevant files:
        </div>
        ...
        {submittedSearchTerm === "" ? <div></div> : (
          matchedComponent 
            ? matchedComponent 
            : <div><div className="orangeLine"/><div className='myprofile-header'>No Files Found for '{submittedSearchTerm}'</div></div>
        )}
      </div>
