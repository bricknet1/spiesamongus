  ...
  return (
    <div>
      <div className="pageContent">
        ...
        <div className="myHistoryHeading">
          Agent Papyrus, click on a mission below to see your personal notes.
        </div>
        ...
        {oneToggled === true && (
          <div style={{ marginTop: "20px" }}>
            <div className="myHistoryDropdownText">
              betrayal was the appetizer, but I'm about to serve up a dish best
              served cold: Getting Even Gazpacho
            </div>
          </div>
        )}
        ...
        {twoToggled === true && (
          <div style={{ marginTop: "20px" }}>
            <div className="myHistoryDropdownText">my only failed mission…</div>
          </div>
        )}
        ...
        {threeToggled === true && (
          <div style={{ marginTop: "20px" }}>
            <div className="myHistoryDropdownText">
              whoops, I guess that's two failed missions. No thanks to Marble,
              that traitor.
            </div>
            <div className="myHistoryDropdownTextSpecial">
              Open Mission File{" "}
              <a style={{ color: "#f9df39" }} href="./opbc" target="_blank">
                here.
              </a>
              <br />
              <br />
              <span style={{ color: "#FF3700" }}>
                *Reminder to never leave your passwords out in your office.
        ...
        {fourToggled === true && (
          <div style={{ marginTop: "20px" }}>
            <div className="myHistoryDropdownText">
              who's scarier? The scariest person ever made? Or the guy that
              found him
            </div>
          </div>
        )}
        ...
        {tenToggled === true && (
          <div style={{ marginTop: "20px" }}>
            <div className="myHistoryDropdownText">
              don't let anyone tell you different. I found that Obelisk! Who are
              you going to believe? Me? Or Jane Goodall?
            </div>
          </div>
        )}
