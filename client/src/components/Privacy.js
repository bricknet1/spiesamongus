...
function Privacy() {
  ...
  return (
    <div className="pageContent" style={{paddingBottom:"3vw"}}>

      <title>Privacy | Spies Among Us</title>

      <div className='orangeBar'>PRIVACY POLICY</div>

      <div style={{fontSize: '4.5vw', fontWeight: "normal", width: "90vw", paddingLeft: "5vw", lineHeight: "8vw"}}>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>WHAT INFORMATION DO WE COLLECT?</span><br/>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>DO WE SHARE YOUR DATA?</span><br/>
        We will never share or sell any of your data with other parties.<br/>
        <br/>
        

        <span style={{fontSize:"8vw", fontWeight:"bold"}}>WHY DO WE COLLECT DATA?</span><br/>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>HOW LONG DO WE KEEP YOUR DATA?</span><br/>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>MARKETING</span><br/>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>OTHER WEBSITES</span><br/>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>CHANGES TO OUR PRIVACY POLICY</span><br/>
        ...
        <span style={{fontSize:"8vw", fontWeight:"bold"}}>HOW TO CONTACT US</span><br/>
