  ...
  return (
    <div>
      <div className="pageContent">
        ...
        {(!(
          submittedPassword.includes("EGREGIOUS") ||
          submittedPassword.includes("EGREGOUS")
        ) ||
          submittedPassword === "" ||
          isAnimating === true) && (
          <div>
            <div className="opbc-subheader">
              WARNING! Classified files. Enter password to continue.
            </div>
        ...
        {!(
          ...
          submittedPassword !== "" && (
            <div className="wrongPassword">
              ...
              <br />
              <img
                src={papyrusheadshake3}
                alt="Papyrus shaking his head"
                className="papyrusheadshake3"
              />
            </div>
          )}
        ...
        {(submittedPassword.includes("EGREGIOUS") ||
          ...
          isAnimating !== true && (
            <div className="rightPassword">
              ...
              <br />
              <div className="killOrder">
                KILL ORDER PHONE CALL
                <br />
                (five years ago)
              </div>
              <br />
              <div className="describeCall">
                Recording of official call between Special Agent PAPYRUS and
                LESLIE, Head of Human Resources
              </div>
              <br />
              ...
              {transcriptToggled === true && (
                <div className="transcript">
                  ...
                  <div className="dialog">
                    Ah. Leslie. Uhh. I need to place a{" "}
                    <strong>
                      <u>kill order</u>
                    </strong>{" "}
                    on{" "}
                    <u>
                      <strong>Agents Marble and Shale.</strong>
                    </u>
                  </div>
                  <div className="leslieDialog">LESLIE</div>
                  ...
                  <div className="leslieDialog">LESLIE</div>
                  <div className="dialog">
                    I see here we have on file a "best friends" form that you
                    submitted... naming... both of them. Would you like me to
                    remove them as your best friends?
                  </div>
                  <div className="papyrusDialog">PAPYRUS</div>
                  <div className="dialog">
                    <i>*Sighs*</i> Did either of them file a best friends form
                    for me?
                  </div>
                  <div className="leslieDialog">LESLIE</div>
                  <div className="dialog">
                    Marble did. Shale filed... a different form.
                  </div>
                  <div className="papyrusDialog">PAPYRUS</div>
                  <div className="dialog">
                    Remove them both. Submit the kill order.{" "}
                    <strong>
                      <u>They both refused a mission</u>
                    </strong>
                    .
                  </div>
                  <div className="leslieDialog">LESLIE</div>
                  ...
                  <div className="leslieDialog">LESLIE</div>
                  <div className="dialog">
                    Do you and the kids have any Christmas plans?
                  </div>
                  <div className="papyrusDialog">PAPYRUS</div>
                  ...
                  <div className="papyrusDialog">PAPYRUS</div>
                  <div className="dialog">
                    We're seeing the Adam Sandler movie Click at their mother's.
                    It's their favorite movie.
                  </div>
                  <div className="leslieDialog">LESLIE</div>
                  <div className="dialog">
                    Ain't that a hoot! You have fun now.
                  </div>
                  <div className="papyrusDialog">PAPYRUS</div>
                  <div className="dialog">Click.</div>
                  <div className="leslieDialog" style={{ color: "#f9df39" }}>
                    *END OF CALL*
                  </div>
                </div>
              )}
