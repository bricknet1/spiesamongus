    ...
    <div style={{backgroundColor: 'black', paddingBottom: '20vw'}}>
      ...
      <div className='termsContainer'>
        ...
        <ol>
          ...
          <ul>
            <li className='termsUL'>By placing your hands on the Obelisk, you agree to share all your data with the Obelisk.</li>
          </ul>

          <li className='termsOL'>Power of Attorney</li>
          <ul>
            <li className='termsUL'>You agree the power of a measly attorney is nothing compared to the power of an all-knowing obelisk (with a law degree).</li>
          </ul>


          <li className='termsOL'>Responsible Behavior</li>
          <ul>
            <li className='termsUL'>You acknowledge that the Obelisk appreciates:
              <ul>
          ...
          <ul>
            <li className='termsUL'>You agree to help Liability, the Obelisk's niece, escape from silver statue prison</li>
          </ul>
