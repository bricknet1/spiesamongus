...
function SearchMarble() {
  ...
  return (
    <div>
      ...
      <div style={{textAlign: 'center', fontSize: '6vw'}}>Prefers to wear <u>blue or black hats</u>.<br /><br />Gender unknown.<br /><br /></div>
      ...
      <div className='transcriptButton'>
        ...
        {transcriptToggled===true && 
          <div className="transcript">
            ...
            <div className="shaleDialog">SHALE:</div>
            <div className="dialog">Rack off Papyrus. I'm calling you as a courtesy.  Stay away from me and stay away from Marble. We will never agree to execute <u>Operation Bubonic Curtsy</u>.</div>
            <div className="papyrusDialog">PAPYRUS:</div>
            ...
            <div className="papyrusDialog">PAPYRUS:</div>
            <div className="dialog">Guess you'll have to trust me then: <i>Marble, your former partner, agreed to do the most evil mission in agency history</i>.</div>
            <div className="shaleDialog">SHALE:</div>
